package kingpesdev.firebaseapp.screencapture.videorecord.activity;
/*
...
import kingpesdev.firebaseapp.screencapture.videorecord.service.ScreenRecorderService;

public final class MainActivity1 extends Activity implements MessageDialogFragment.MessageDialogListener {
			...
			case R.id.record_button:
				if (checkPermissionWriteExternalStorage() && checkPermissionAudio()) {
					if (isChecked) {
						...
						final Intent intent = new Intent(MainActivity1.this, ScreenRecorderService.class);
	...
	private static final class MyBroadcastReceiver extends BroadcastReceiver {
		private final WeakReference<MainActivity1> mWeakParent;
		public MyBroadcastReceiver(final MainActivity1 parent) {
			mWeakParent = new WeakReference<MainActivity1>(parent);
		}
		...
		public void onReceive(final Context context, final Intent intent) {
			...
			if (ScreenRecorderService.ACTION_QUERY_STATUS_RESULT.equals(action)) {
				...
				final MainActivity1 parent = mWeakParent.get();
				if (parent != null) {
